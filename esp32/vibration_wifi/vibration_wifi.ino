...
/* ── User configuration ──────────────────────────────────────── */
const char* WIFI_SSID     = "Hym";
const char* WIFI_PASSWORD = "asdasd123";
const char* SERVER_URL    = "http://172.20.10.3:5000/data";
/*
...
void loop()
{
    ...
    Serial.printf("[DATA] raw=%u  voltage=%.3f V  motion=%d\n", raw, voltage, motion);

    /* Forward to Flask server — full JSON line is sent as-is */
